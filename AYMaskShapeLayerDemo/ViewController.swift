...
//  AYMaskShapeLayerDemo
//
//  Created by wpsd on 2017/2/21.
...
//        let draftPath = UIBezierPath(roundedRect: CGRect(x: 0, y: 0, width: width, height: height), cornerRadius: 5)
        ...
        draftPath.addArc(withCenter: CGPoint(x: cornerRadius, y: cornerRadius), radius: cornerRadius, startAngle: -(CGFloat)(M_PI_2), endAngle: (CGFloat)(M_PI), clockwise: false)
        draftPath.addLine(to: CGPoint(x: 0, y: height - cornerRadius))
        draftPath.addArc(withCenter: CGPoint(x: cornerRadius, y: height - cornerRadius), radius: cornerRadius, startAngle: (CGFloat)(M_PI), endAngle: (CGFloat)(M_PI_2), clockwise: false)
        draftPath.addLine(to: CGPoint(x: width - cornerRadius, y: height))
        draftPath.addArc(withCenter: CGPoint(x: width - cornerRadius, y: height - cornerRadius), radius: cornerRadius, startAngle: (CGFloat)(M_PI_2), endAngle: 0, clockwise: false)
        draftPath.addLine(to: CGPoint(x: width, y: cornerRadius))
        draftPath.addArc(withCenter: CGPoint(x: width - cornerRadius, y: cornerRadius), radius: cornerRadius, startAngle: 0, endAngle: -(CGFloat)(M_PI_2), clockwise: false)
